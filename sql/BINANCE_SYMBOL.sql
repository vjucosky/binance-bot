...
CREATE TABLE BINANCE_SYMBOL_KLINE (
	...
	INDEX IX__BINANCE_SYMBOL_KLINE__OPEN_TIMESTAMP (OPEN_TIMESTAMP),
	INDEX IX__BINANCE_SYMBOL_KLINE__CLOSE_TIMESTAMP (CLOSE_TIMESTAMP)
)
...
CREATE TABLE BINANCE_SYMBOL_TRADE (
	...
	INDEX IX__BINANCE_SYMBOL_TRADE__EXECUTION_TIMESTAMP (EXECUTION_TIMESTAMP)
)
...
CREATE TABLE BINANCE_SYMBOL_AGGTRADE (
	...
	INDEX IX__BINANCE_SYMBOL_AGGTRADE__EXECUTION_TIMESTAMP (EXECUTION_TIMESTAMP)
)
